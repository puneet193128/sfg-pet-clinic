...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        owner1.setAddress(" Test address of owner1");
        owner1.setCity("Bellevue");
        owner1.setTelephone("123456789");

        Pet puneetPet = new Pet();
        puneetPet.setOwner(owner1);
        puneetPet.setBirthDate(LocalDate.now());
        puneetPet.setName("Barfi");
        puneetPet.setPetType(savedDogPetType);
        owner1.getPets().add(puneetPet);
        ...
        owner2.setAddress(" Test address of owner2");
        owner2.setCity("Redmond");
